...
gdjs.LoadCode.asyncCallback9356236 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LoadCode.asyncCallback9356236(runtimeScene, asyncObjectsList)));
}
}
